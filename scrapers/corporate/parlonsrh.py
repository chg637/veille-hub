"""
Scraper Parlons RH — flux RSS RH stratégique.

Source de qualité orientée stratégie RH et leadership, complémentaire de MyRHline.
"""
...
RSS_URL = "https://www.parlonsrh.com/feed/"
SOURCE_NAME = "Parlons RH"
SOURCE_TIER = 2
VERTICAL = "corporate"

KEYWORDS_NOMINATION = ["nomme", "nomination", "rejoint", "arrive", "devient"]
KEYWORDS_RECRUT = ["recrut", "embauch", "talent", "candidat"]
KEYWORDS_IA = ["intelligence artificielle", "ia ", " ai ", "gpt", "llm"]
KEYWORDS_TRANSFO = ["transformation", "skills", "compétences"]
